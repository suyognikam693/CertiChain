...
<button type="button" className="icon-btn shrink-0 border border-emerald-600 bg-emerald-600 px-4 text-white rounded-r-[6px] hover:bg-emerald-500" data-copy-target="share-certificate-hash-input" aria-label="Copy certificate hash" onClick={() => navigator.clipboard.writeText(selectedCred?.credential_hash || '')}>
...
<button type="button" className="icon-btn shrink-0 border border-emerald-600 bg-emerald-600 px-3 py-1 text-white rounded-[6px] hover:bg-emerald-500 text-[10px]" onClick={() => navigator.clipboard.writeText(selectedCred?.batch_id || '')}>Copy</button>
</div>
<div className="flex items-center gap-2">
...
<button type="button" className="icon-btn shrink-0 border border-emerald-600 bg-emerald-600 px-3 py-1 text-white rounded-[6px] hover:bg-emerald-500 text-[10px]" onClick={() => navigator.clipboard.writeText(String(selectedCred?.leaf_index ?? ''))}>Copy</button>
</div>
<div>
<div className="flex items-center gap-2 mb-1">
<p className="font-mono text-[11px] text-slate-300 flex-1">Merkle Proof:</p>
<button type="button" className="icon-btn shrink-0 border border-emerald-600 bg-emerald-600 px-3 py-1 text-white rounded-[6px] hover:bg-emerald-500 text-[10px]" onClick={() => navigator.clipboard.writeText(selectedCred ? JSON.stringify(selectedCred.proof || [], null, 2) : '')}>Copy</button>
</div>
